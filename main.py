...
api_id = 25898994
api_hash = "a5e6b163839bb82b4ca59b8dc6a3b5d4"
admins = {8024516184}  # مجموعه برای جلوگیری از تکرار
...
deepseek_api_key = "8024516184:upyI9z0kOQ7J3r6@Api_ManagerRoBot"
...
async def auto_reply_private(client, message):
    ...
    if not always_online_enabled and auto_reply_enabled:
        ...
        if user_id not in sent_offline_notice:
            await message.reply_text("ℹ️ من فعلاً آنلاین نیستم. لطفاً بعداً پیام بدید. برای استفاده از هوش مصنوعی قبل پیام ارسالی علامت + بگذارید. مثال : +بات")
